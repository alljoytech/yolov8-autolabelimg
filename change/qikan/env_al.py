...
class limition:
    ...
    def saveCSV(self):   #保存数据方便matlab绘图(受不了matplotlib三维了)
        ...
        np.savetxt('./data_csv/attaction_load.csv', self.attaction_load, delimiter=',')
        np.savetxt('./data_csv/repulsion_load.csv', self.repulsion_load, delimiter=',')
        np.savetxt('./data_csv/comfore.csv', self.comfore, delimiter=',')
        np.savetxt('./data_csv/unitforce.csv', self.unitforce, delimiter=',')
    ...
    def saveCSV_1(self):   #保存数据方便matlab绘图(受不了matplotlib三维了)
        ...
        np.savetxt('./data_csv_1/attaction_load.csv', self.attaction_load, delimiter=',')
        np.savetxt('./data_csv_1/repulsion_load.csv', self.repulsion_load, delimiter=',')
        np.savetxt('./data_csv_1/comfore.csv', self.comfore, delimiter=',')
        np.savetxt('./data_csv_1/unitforce.csv', self.unitforce, delimiter=',')
